...
Les exercices sont concrets, realisables avec ChatGPT/Claude, et adaptes au metier du client.
Chaque exercice inclut une consigne claire et un corrige modele. Tu ecris en francais.
Tu reponds STRICTEMENT en JSON valide, sans texte autour.`;
...
La formation doit suivre cette progression: Introduction, Comprendre l'IA, Decouvrir ChatGPT, Cas d'usage metier, Automatisations, Bonnes pratiques, Atelier pratique, Conclusion.
